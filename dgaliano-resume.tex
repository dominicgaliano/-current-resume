  ...
  \resumeSubHeadingListStart    
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Collaborated with technical and non-technical client stakeholders to resolve integration challenges, align the pipeline with compliance regulations, and ensure long-term scalability and cost savings}
        \resumeItem{Developed an LLM-powered chatbot using Gemini 1.5 Pro and Gradio to streamline onboarding workflows for new hires, automating structured tasks such as status tracking and document submission, reducing manual support interactions by an estimated 75\%}
      \resumeItemListEnd
    \resumeSubheading
